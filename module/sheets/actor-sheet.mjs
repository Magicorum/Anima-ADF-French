 ...
 */
export class AnimaSheet extends api.HandlebarsApplicationMixin(
  sheets.ActorSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/FrenchAnimaCooler/templates/actor/header.hbs',
    },
    tabs: {
  ...
  _configureRenderOptions(options) {
    ...
    options.parts = ['header', 'tabs', 'Biographie'];
  ...
  async _preparePartContext(partId, context) {
    switch (partId) {
      ...
      case 'Biographie':
        context.tab = context.tabs[partId];
        // Enrich Biographie info for display
  ...
  _getTabs(parts) {
    ...
    if (!this.tabGroups[tabGroup]) this.tabGroups[tabGroup] = 'Biographie';
